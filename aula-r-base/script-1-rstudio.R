...
setwd("/home/reinaldo/Documentos/Code/curso_r/versao_atual/201805-introducao-a-programacao-em-r-master/aula-r-base")

# Alt + "-" : cria a seta

# Esse é o script. Aqui nós escrevemos nosso código.

# Pacote do Pipe e tidyverse
...
# Exemplo de carregamento e pipes
imdb <- readRDS("data/dados_imdb.rds")
